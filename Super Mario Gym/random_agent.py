"""
random_agent.py - Python script supplied by OpenAI for the OpenAI Retro Gym.
Generates random input to an emulation instance of whatever game specified.
'-r' can be used to record the emulation instance to a .bk2 file
